...
class Autoencoder(nn.Module):
    def __init__(self, latent_dim, dim1, dim2):
        ...
        self.encoder = nn.Sequential( 
                ...
                # output volume = 64*216 = 13824
                nn.Flatten(),
                #TODO remove, its use is only for ENCODER without VAE
                #nn.Linear(90112, self.latent_dim)
                )
                #64*216*64 = 884736 #output of flatten
        ...
        self.decoder = nn.Sequential(
            ...
            Reshape(-1, 64, typos2(DIM_1, DIM_2), typos3(DIM_1, DIM_2)),
